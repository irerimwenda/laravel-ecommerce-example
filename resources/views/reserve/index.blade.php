...
@section('content')
    ...
    <div class="cart-section container">
        <div>
            ...
            <h2>{{ Cart::count() }} item(s) Reserved</h2>
            ...
            <div class="cart-totals">
                ...
                <div class="cart-totals-right">
                    ...
                    <div class="cart-totals-subtotal">
                        ...
                        <span class="cart-totals-total">{{ presentPrice($newTotal/2) }}</span>
                    </div>
                </div>
            </div> <!-- end cart-totals -->

            <div class="cart-buttons">
                <a href="{{ route('accept-reserve', $product->id) }}" class="button">Accept & Reserve</a>
            </div>

            @else

                <h3>No items Reserved</h3>
